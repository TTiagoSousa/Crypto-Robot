def calculate_transaction_result_short(close_value, open_value, capital, fees):

    if open_value > close_value:  # Lucro se o preço cair
        percentual_trade = (open_value - close_value) / open_value
    else:
        percentual_trade = (close_value - open_value) / open_value * -1  # Prejuízo se o preço subir
